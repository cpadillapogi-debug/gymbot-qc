...
import { matchFaqIntent } from "./faq-response-service.js";
...
export async function callGemini(userMessage, history, memorySummary, gymInfoOverride){
  // PATCH: answer from the fixed FAQ list first — no API call, no key
  // needed, no "model retired" surprises. Only falls through to Gemini
  // below if the message doesn't match any known question.
