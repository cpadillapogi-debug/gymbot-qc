...
export const CONFIG = Object.freeze({
  ...
  // Owner-facing "Contact support" link (Help page). Empty string means
  // no Facebook Page/Messenger link exists yet — the Help page falls
  // back to plain text instead of a dead button. Fill this in with
  // your real Messenger link (e.g. "https://m.me/yourpagename") once
  // you have a Page — nothing else needs to change.
  SUPPORT_CONTACT_URL: "",
  ...
  SUBSCRIPTION_DEFAULT_PLAN_ID: "starter", // plan a brand-new gym starts trialing on if none is chosen (e.g. register.html, which has no plan picker)
