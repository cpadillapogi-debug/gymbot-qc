...
import { renderAttentionPanel } from "./admin-attention-panel-ui.js";
import { getAttentionSummary } from "../services/admin-attention-service.js";
import { renderGrowthPanel } from "./admin-growth-panel-ui.js";
...
export async function renderAdminOverviewPage(){
  ...
  root.innerHTML = `
    <div class="owner-metric-grid">
      ...
      <div class="owner-metric-card">
        <div class="owner-metric-num">${attention.total}</div>
        <div class="owner-metric-label">Issues needing attention</div>
      </div>
    </div>

    <div class="owner-panel" id="adminAttentionPanel"><!-- injected below --></div>

    <div class="owner-panel" id="adminGrowthPanel"><!-- injected below --></div>
  ...
  renderAttentionPanel(document.getElementById("adminAttentionPanel"));
  renderGrowthPanel(document.getElementById("adminGrowthPanel"));
}
